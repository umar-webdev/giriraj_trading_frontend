    ...
    <>
      <Form>
        ...
        <Form.Group controlId="formBasicPassword">
          ...
          <Form.Control type={showPassword ? 'text' : 'password'} name="password" placeholder="Password" onChange={handleInputChange} />
          <Form.Text className="text">
            <Button className="learn-more-button"  onClick={() => setShowPassword(!showPassword)}>
