...
const ProductCollection = () => {
    return(
        ...
        <div id="homepage-collection-grid-container">
          <h2 className="mb-5" style={{ fontFamily: 'Public Sans, sans-serif', fontStyle: 'italic', fontWeight: '400', textAlign: 'center' }}>
                  Our Products
                </h2>
        <div className="collection-row-1" style={{ display: 'flex' }}>
          ...
          <div style={{ width: '50%', display: 'flex' }}>
            {/* Product 1 */}
            <a href="/wiremesh" className="image-container">
              {/* Product Image */}
            ...
            {/* Product 2 */}
            <a href="/conceal_lock" className="image-container">
              <div style={{ position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ width: '50%', display: 'flex' }}>
            {/* Product 3 */}
            <a href="/wool_pipe" className="image-container">
              <div style={{ position: 'relative', overflow: 'hidden' }}>
            ...
            {/* Product 4 */}
            <a href="/sliding_window_roller" className="image-container">
              <div style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ width: '50%' }}>
          <div style={{ width: '100%', display: 'flex' }}>
            {/* Product 1 */}
            <a href="/louvers" className="image-container">
              <div style={{ position: 'relative', overflow: 'hidden' }}>
            ...
            {/* Product 2 */}
         <a href="/pvc_gasket" className="image-container">
            <div style={{ position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ width: '100%' }}>
            <div style={{ padding: '5px 5px 5px 5px' }}>
              {/* Product 3 */}
              <a href="/domal_accessories" style={{ width: '100%' }}>
                <div style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ width: '100%' }}>
        <div style={{ padding: '5px' }}>
          <a href="/silicone_sealant" style={{ width: '100%' }}>
            <div style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ width: '100%', display: 'flex' }}>
      <a href="/friction_stay" className="image-container">
        <div style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <a href="/floor_spring_&_door_closer" className="image-container">
        <div style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="collection-row-1" style={{ display: 'flex' }}>
        <div style={{ width: '50%', display: 'flex' }}>
          {/* Product 4 */}
          <a href="/Acrylic_Foam_Tape_&_Spacer_Tape" className="image-container">
            <div style={{ position: 'relative', overflow: 'hidden' }}>
          ...
          <a href="/Fiber_Bidding" className="image-container">
      <div style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ width: '50%', display: 'flex' }}>
      <a href="/nails" className="image-container">
        <div style={{ position: 'relative', overflow: 'hidden' }}>
     ...
     <a href="/guns" className="image-container">
        <div style={{ position: 'relative', overflow: 'hidden' }}>
