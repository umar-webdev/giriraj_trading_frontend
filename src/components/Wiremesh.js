...
const products = [
  { name: 'Aluminium Wiremesh', MOQ: '80 pc', image: "/39.jpg", rating: 4.8, rate: 10, info:'14*14, 18*16  Colour: SS Finish | Bright Finish | Black Finish Length: 30 meters Long Packing: 1 Roll in Box' },
  { name: 'SS Wiremesh', MOQ: '80 pc', image: "/70.jpg", rating: 4.8, rate: 20, info:'Grade: 202, 304  Colour: SS Finish | Black Finish  Length: 100ft  Packing: 1 Roll in Bag'  },
  { name: 'Fiber Wiremesh', MOQ: '80 pc', image: "/43.jpg", rating: 4.8, rate: 30, info:'18*16 | 120 GSM Colour: Black | Grey | Ivory Available Size: 2ft to 5ft. Length: 100ft Packing: 10 Roll in Bag'  },
   ];
